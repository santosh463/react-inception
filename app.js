...
const JsxHeading = () => <h1 className="heading-class">Namaste JS using JSX</h1>;
    ...
    return (
        <div className="header">
            <div className="logo-container">
                <img src="https://yt3.ggpht.com/ytc/AMLnZu_EC-ECXAxRAixWGEfMsE1rdSoetBHyxmLNdtCB=s900-c-k-c0x00ffffff-no-rj" className="logo" />
            </div>
